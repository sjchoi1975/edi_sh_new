<template>
  <div class="notice-create-view">
    <h2 style="margin-top:0;">신규 업체 등록</h2>
    <form @submit.prevent="handleSubmit" class="notice-form grid-form">
      ...
      <div class="form-row">
        ...
        <div class="form-col">
          <label>수수료 등급</label>
          <Dropdown v-model="commissionGrade" :options="commissionGradeOptions" optionLabel="label" optionValue="value" placeholder="등급 선택" />
        </div>
      </div>
      <div class="form-row">
        <div class="form-col">
        ...
        <div class="form-col">
          <label>승인여부</label>
          <Dropdown v-model="approvalStatus" :options="approvalStatusOptions" optionLabel="label" optionValue="value" placeholder="승인여부 선택" />
        </div>
