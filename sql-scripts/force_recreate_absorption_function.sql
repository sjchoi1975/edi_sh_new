-- 강제로 흡수율 분석 함수를 완전히 재생성

-- 1. 모든 버전의 함수 삭제 (매개변수 타입에 관계없이)
...
DROP FUNCTION IF EXISTS public.calculate_absorption_rates(character varying);
